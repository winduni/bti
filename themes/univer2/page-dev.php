<?php get_header(); ?>
    ...
    <style>
        ...
        .answ1{
            background: url(<?php bloginfo('template_url'); ?>/img/anw1.png);
            top: 230px;

        }
        .answ2{
            background: url(<?php bloginfo('template_url'); ?>/img/anw2.png);
            top: 323px;
            height: 185px !important;
        }
        .answ4{
            background: url(<?php bloginfo('template_url'); ?>/img/anw4.png);
            top: 362px;
            height: 140px !important;
        }        .answ5{
                     background: url(<?php bloginfo('template_url'); ?>/img/anw5.png);
                     top: 362px;
                     height: 140px !important;
                 }
        .answ3{
            background: url(<?php bloginfo('template_url'); ?>/img/anw3.png);
            top: 483px;
            height: 140px !important;
        }
    ...
    <a href="https://webmail.bti.secna.ru/" target="_blank"><div class="add_comment answ5 hidden-xs"></div></a>
    <a href="/students/rasp/"> <div class="add_comment answ3 hidden-xs"></div></a>
    <div class="bg-sl">
        <div class="container-fluid block-content">
            <div id="owl-main-slider" class="owl-carousel enable-owl-carousel" data-single-item="true" data-pagination="false" data-auto-play="true" data-main-slider="true" data-stop-on-hover="true">
                ...
                <a href="http://old.bti.secna.ru/eios/">
                    <div class="item">
    ...
    <div class="bg-image page-title slider-bottom" >
                            ...
                            <div class="service-item col-xs-12  col-sm-6  col-md-3 col-lg-3 wow zoomIn news" data-wow-delay="0.3s">
                                <a href="<?php echo get_permalink($post->ID); ?>"><?php
                                    ...
                                    if ( has_post_thumbnail() ): // если миниатюра есть
                                        ...
                                        <img src="<?php bloginfo('template_url'); ?>/img/no-img.jpg" width="100%">
                                    <?endif;
    ...
    <div class="container-fluid" style="margin-bottom:30px;">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                    ...
                    <div style="background:#f7f7f7;width: 100%;">
                        ...
                        <div>
                            <div style="padding:15px 5px;">
                                ...
                                <a href="http://www.bti.secna.ru/ads/uvazhaemye-kollegi1/" style="color:#23527c;font-size:14px;">
                                    Уважаемые коллеги! Представляем для ознакомления проект Программы развития Алтайского государственного технического университета им. И.И. Ползунова на 2018-2023 гг.</a>
                    ...
                    <div style="background:#f7f7f7;width: 100%;">
                        ...
                        <div>
                            <div style="padding:15px 5px;">
                                ...
                                <a href="http://www.bti.secna.ru/ads/grafik-raboty-i-otdyha-biblioteki-v-svyazi-s-predstoyashhimi-nerabochimi-prazdnichnymi-dnyami-dnem-8-marta-mezhdunarodnym-zhenskim-dnem/" style="color:#23527c;font-size:14px;">
                                    График работы и отдыха библиотеки в связи с предстоящими нерабочими праздничными днями (Днем 8 марта – Международным женским днем)</a>
                    ...
                    <div style="background:#f7f7f7;width: 100%;">
                        ...
                        <div>
                            <div style="padding:15px 5px;">
                                ...
                                <a href="http://www.bti.secna.ru/ads/federalnoe-kazennoe-predpriyatie-bijskij-oleumnyj-zavod-priglashaet-na-rabotu/" style="color:#23527c;font-size:14px;">
                                    Федеральное казенное предприятие «Бийский олеумный завод» приглашает на работу</a>
                    ...
                    <div style="background:#f7f7f7;width: 100%;">
                        ...
                        <div>
                            <div style="padding:15px 5px;">
                                ...
                                <a href="http://www.bti.secna.ru/ads/vnimaniyu-studentov-vseh-form-obucheniya/" style="color:#23527c;font-size:14px;">
                                    Вниманию студентов всех форм обучения!</a>
                ...
                <div align=right>
                    <a href="/ads/" style="color:#666"><i class="fa fa-newspaper-o"></i> Все объявления</a>
                </div>
            ...
            <div class="col-md-3">
                ...
                <img src="<?php bloginfo('template_url'); ?>/img/1253551080_mxmix12072.jpg" width=100% style="margin-top:50px;">
                ...
                <div class="sidebar-container">
                    <div style="background-color: #df5410;width:100%;padding:15px;">
                        ...
                        <br><a href="http://old.bti.secna.ru/eios/"><i class="fa fa-caret-right" aria-hidden="true"></i>
    ...
    <div class="block-content blog-section" style="margin-top:30px;">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-md-6 col-lg-6 one-news wow fadeInLeft" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInLeft;">
                    ...
                    <div style="background-image:url(<?php bloginfo('template_url'); ?>/img/mon.png););">
                        <div>
                            <a href="http://old.bti.secna.ru/eios/"><h3 class="ei11">Электронная информационно-образовательная среда</h3></a>
    ...
    <div class="container-fluid partners block-content">
        ...
        <div id="partners" class="owl-carousel enable-owl-carousel none-bg" data-pagination="false" data-navigation="true" data-min450="2" data-min600="2" data-min768="4">
            ...
            <div class="wow rotateIn" data-wow-delay="0.3s"><a href="http://old.bti.secna.ru/total/lan.shtml"><img src="http://www.bti.secna.ru/wp-content/uploads/2018/03/14.png" alt="Img"></a></div>
            <div class="wow rotateIn" data-wow-delay="0.3s"><a href="http://old.bti.secna.ru/total/ubonline.shtml"><img src="http://www.bti.secna.ru/wp-content/uploads/2018/03/16.png" alt="Img"></a></div>
    ...
    <div class="container-fluid partners block-content">
        ...
        <div class="small-posts">
            <div class="wow fadeInUp" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp;">
                <div class="post-info" style="border: 1px solid #fff;">
