        ...
        <div class="container-fluid">
            ...
            <div class="topmenu row ttt" >
                ...
                <nav class="text-right col-xs-1 col-xs-offset-8 hiddend-lg hiden-sm hidden-lm temp-xs">
                    ...
                    <iframe src="http://old.bti.secna.ru/web-thermo/index.shtml" scrolling="auto" frameborder="0" width=100px></iframe>
                </nav>

                <nav class="text-right col-xs-4 hiddend-lg hiden-sm hidden-lm rasp-xs">
                    <a href="http://db.biysk.secna.ru/schedule/test.rasp_ind2?cury=2017&cursem=2" style="font-size:8px"> Расписание</a>
                </nav>
            ...
            <div class="topmenu row hidden-xs">
                ...
                <nav class="text-right col-sm-2 col-md-2 col-lg-2 hidden-xs hidden-visible-eye">
                    <a href="http://old.bti.secna.ru"><!--i class="fa fa-eye" aria-hidden="true"></i--> старая версия сайта</a>
                </nav>
            ...
            <nav class="main-menu navbar-main-slide">
                ...
                <ul class="nav navbar-nav navbar-main">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li> <a href="http://old.bti.secna.ru/total/fotogal.shtml">Фотогалерея</a></li>
                            <li><a href="http://old.bti.secna.ru/total/video_pre.shtml">Видеоархив</a></li>
                            ...
                            <li><a href="http://old.bti.secna.ru/total/karta.shtml">Карта корпусов</a></li>
                ...
                <ul class="nav navbar-nav navbar-main">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="<?php echo home_url();?>/dopolnitelnoe-obrazovanie/">Дополнительное образование</a></li>
                            <li><a href="http://old.bti.secna.ru/education/ovz">Образование для инвалидов и лиц с ОВЗ </a></li>
                            ...
                            <li><a href="https://app.bti.secna.ru:8443/kab/emp.reg">Личный кабинет сотрудника </a></li>
                ...
                <ul class="nav navbar-nav navbar-main">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo home_url();?>/abitur/">Приемная кампания 2018 </a></li>
                              <li><a href="http://old.bti.secna.ru/education/spec/index.shtml">Направления подготовки (специальности)</a></li>
                ...
                <ul class="nav navbar-nav navbar-main">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="http://old.bti.secna.ru/students/stud.shtml"> В	неучебная и воспитательная деятельность</a></li>
                            <li><a href="http://old.bti.secna.ru/students/profkom.shtml"> Профсоюз студентов</a></li>
                            <li><a href="<?php echo home_url();?>/sport/"> Спорт в институте</a></li>
                            ...
                            <li><a href="http://old.bti.secna.ru/students/obch.shtml"> Информация об общежитии</a></li>
                ...
                <ul class="nav navbar-nav navbar-main">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="http://db.biysk.secna.ru/shablon/shablon.seniorbti.main"> Наши выпускники</a></li>
                        </ul>
                    </li>
                ...
                <div class="single-nav nav1">
                    ...
                    <div class="descr d1">
                        <div class="col-md-6">
                            ...
                            <a href="http://old.bti.secna.ru/total/fotogal.shtml">Фотогалерея</a>
                            <br> <a href="http://old.bti.secna.ru/total/video_pre.shtml">Видеоархив</a>
                        </div>
                        <div class="col-md-6">
                            ...
                            <br> <a href="http://old.bti.secna.ru/total/karta.shtml">Карта корпусов</a>
                ...
                <div class="single-nav nav2">
                    ...
                    <div class="descr d2">
                        <div class="col-md-5">
                            ...
                            <br><a href="<?php echo home_url();?>/dopolnitelnoe-obrazovanie/">Дополнительное образование</a>
                            <br><a href="http://old.bti.secna.ru/education/ovz">Образование для инвалидов и лиц с ОВЗ </a>
                        ...
                        <div class="col-md-7">
                            ...
                            <br><a href="https://student.altstu.ru/login/">Личный кабинет студента</a> | <a href="https://app.bti.secna.ru:8443/kab/emp.reg"> сотрудника </a> | <a href="http://teacher.altstu.ru/auth/login/">преподавателя</a> | <a href="http://db.biysk.secna.ru/graduate/postgrad.form_login">аспиранта </a>
                ...
                <div class="single-nav nav4">
                    ...
                    <div class="descr d4">
                        <div class="col-md-5">
                            ...
                            <a href="<?php echo home_url();?>/abitur/">Приемная кампания 2018 </a>
                            <br><a href="http://old.bti.secna.ru/education/spec/index.shtml">Направления подготовки (специальности)</a>
                ...
                <div class="single-nav nav5">
                    ...
                    <div class="descr d5">
                        <div class="col-md-6">
                            ...
                            <a href="http://old.bti.secna.ru/students/stud.shtml"> Внеучебная и воспитательная деятельность</a>
                            <br><a href="http://old.bti.secna.ru/students/profkom.shtml"> Профсоюз студентов</a>
                            <br><a href="http://old.bti.secna.ru/culture/sport.shtml"> Спорт в институте</a>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <br><a href="http://old.bti.secna.ru/students/obch.shtml"> Информация об общежитии</a>
                ...
                <div class="single-nav nav6">
                    ...
                    <div class="descr d6">
                        ...
                        <div class="col-md-6">
                            ...
                            <br><a href="http://db.biysk.secna.ru/shablon/shablon.seniorbti.main"> Наши выпускники</a>
                        </div>
                ...
                <div class="single-nav nav7">
                    ...
                    <div class="descr d7">
                        <div class="col-md-4">
                            ...
                            <br><a href="https://teacher.altstu.ru/auth/login/"> Личный кабинет преподавателя</a> / <a href="https://app.bti.secna.ru:8443/kab/emp.reg">сотрудника</a>
                        </div>
                        <div class="col-md-4">
